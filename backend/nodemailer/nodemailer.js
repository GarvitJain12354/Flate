...
exports.sendEmailPdf = async(uploadedFile, email) => {
  ...
  const mailOptions = {
    from: '"Rent Agreement" <your-email@example.com>', // sender address
    to: email, // list of receivers
    subject: "Your Rent Agreement",
    text: "Attached is your rent agreement!",
    attachments: [
      {
        filename: uploadedFile.name,
        content: uploadedFile.data, // ⬅️ here you use the Buffer directly
      },
    ],
  };
