      ...
      <div className="   py-10 min-w-[80vw] px-3    ">
        <div className="flex flex-col items-center w-full  h-full justify-center gap-4">
              ...
              <div className="flex mt-6 flex-col items-start w-full  gap-2 p-2">
                ...
                <div className="relative w-full h-full">
                  {!croppedImage ? (
                    ...
                    <div className="flex relative flex-col items-center w-24 h-24  justify-center">
                      <img
                        src={croppedImage}
                        alt="Cropped"
                        className="rounded-b-2xl rounded-t-full h-full w-full object-cover border-[1px] border-primary"
                      />
                      <i
                        onClick={() => setCroppedImage(null)}
                        className="ri-close-circle-fill absolute top-0 right-2 cursor-pointer text-lg text-primary"
                      ></i>
                    </div>
                  )}
                </div>
          ...
          <Modal open={open} onClose={handleClose}>
            ...
            >
              <div className="flex flex-col bg-white p-2 items-center justify-center gap-2">
                <ReactCrop
                  src={selectedImage}
                  crop={crop}
