...
import EmbeddedWebsite from "../Pages/Blog";
// import ViewCities from "../Pages/viewcities/ViewCities";
...
function App() {
  ...
  const [adminphone, setadminphone] = useState(false);
      ...
      <Routes>
        ...
        {!isAuthenticated && (
          <>
            <Route
              path="login"
              element={<LoginPage phone={phone} setphone={setphone} />}
            />
            <Route
              path="adminlogin"
              element={
                <LoginPage phone={adminphone} setphone={setadminphone} />
              }
            />
        ...
        {isAuthenticated && (
          <>
            ...
            <Route path="/blog" element={<EmbeddedWebsite />} />
            <Route
              path="/rentagreement"
